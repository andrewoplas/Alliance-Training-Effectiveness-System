	...
	<div class="container-fluid">
		<div class="row bg-title">
                 <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                     <h4 class="page-title">${ form.description }</h4> </div>
                      		...
                      		<div class="panel-body">
                      			<div class="controls-container">
                      				<c:forEach var="question" items="${ questions }" varStatus="loop">
										...
										<span class="numbers">${ loop.count }</span>
										<input type="text" class="form-control m-b-5 question" value="${ question.description }" data-type="${ question.type }" />
                      					...
                      					<c:choose>
                      						...
                      						<c:when test="${ question.type == 'radiobutton' }">
                      							<div class="option-container">
													...
													<div class="item">
												    	...
												    	<input type="text" class="form-control optionName" value="${ option.description }" data-id="${ option.id }">
											...
											<i class="btn-delete mdi mdi-delete" data-toggle="tooltip" title="Delete " data-placement="top"></i>
										</div>
									</div>
